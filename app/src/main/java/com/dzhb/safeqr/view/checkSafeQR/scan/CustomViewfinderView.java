...
public class CustomViewfinderView extends ViewfinderView {
     ...
     * 扫描线厚度
     */
    public float mScanLineDepth = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 4,
            getResources().getDisplayMetrics());

    /**
     * 扫描线每次重绘的移动距离
     */
    public float mScanLineDy = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 3,
            getResources().getDisplayMetrics());
     ...
     * 线性梯度各个位置对应的颜色值
     */
    public int[] mScanLineColor = new int[]{0x00FFFFFF, android.R.color.white, 0x00FFFFFF};
...
//                frame.top + frame.height() * mLineRate, paint);
//
//        canvas.drawRect(frame.left, frame.bottom - mLineDepth,
//                frame.left + frame.width() * mLineRate, frame.bottom, paint);
...
//                frame.bottom - mLineDepth, frame.right, frame.bottom, paint);
//        canvas.drawRect(frame.right - mLineDepth,
//                frame.bottom - frame.height() * mLineRate, frame.right, frame.bottom, paint);
...
//        //设置扫描框外的背景
//        // Draw the exterior (i.e. outside the framing rect) darkened
        paint.setColor(Color.parseColor("#4977f0"));
